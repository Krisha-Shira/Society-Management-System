...
//     required this.role,
//     this.profilePicture = '', required DateTime createdAt,
//   });
...
//     }
//     return username.length >= 2 ? username.substring(0, 2).toUpperCase() : 'U';
//   }
// }
...
/// User model class representing a society member
class User {
  final String id;
  final String username;
  final String email;
