...
class _MaintenanceBillingScreenState extends State<MaintenanceBillingScreen> {
  ...
  void _submitMaintenanceForm() {
    ...
    _showSnack(
        "Maintenance ($_maintenancePaymentType) details added successfully!",
        Colors.green);
  ...
  void _submitBillingForm() {
    ...
    _showSnack("Billing ($_billingPaymentType) details added successfully!",
        Colors.green);
